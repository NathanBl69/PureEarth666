            ...
            <div class="container">
              ...
              <article class="article">
                <div class="post-img" style="position: relative">
                  <a href="<?php echo e($videoLink); ?>" target="_blank">
                    <img src="<?php echo e(asset('img/education/'.$image)); ?>" alt="" class="img-fluid w-100">
                  </a>
                </div>
                <h2 class="title"><?php echo e($title); ?></h2>
                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <?php echo e($author); ?></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <time datetime="2020-01-01"><?php echo e($date); ?></time></li>
                  </ul>
                </div>
                <div class="content">
                  <p>
                ...
                <div class="meta-bottom">
                  <a href="<?php echo e($videoLink); ?>" target="_blank"><i class="bi bi-youtube"></i> Video Link</a>
                </div>
              </article>
          ...
          <div class="widgets-container">
            <div class="blog-author-widget widget-item">
              ...
              <div class="d-flex flex-column align-items-center">
                <img src="<?php echo e(asset('img/education/'.$imageAuthor)); ?>" class="rounded-circle flex-shrink-0" alt="">
...
<?php echo $__env->make('layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\PureEarth-Test-app\resources\views/education-detail.blade.php ENDPATH**/ ?>