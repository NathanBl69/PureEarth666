      ...
      <div class="container">
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6">
            <article>
              <div class="post-img">
                <a href="/education/1"><img src="<?php echo e(asset('img/education/education-1.jpg')); ?>" alt="" class="img-fluid"></a>
              </div>
              <div class="meta-top">
                <ul>
          ...
          <div class="col-lg-4 col-md-6">
            <article>
              <div class="post-img">
                <a href="/education/2"><img src="<?php echo e(asset('img/education/education-2.jpg')); ?>" alt="" class="img-fluid"></a>
              </div>
              <div class="meta-top">
                <ul>
          ...
          <div class="col-lg-4 col-md-6">
            <article>
              <div class="post-img">
                <a href="/education/3"><img src="<?php echo e(asset('img/education/education-3.jpg')); ?>" alt="" class="img-fluid"></a>
              </div>
              <div class="meta-top">
                <ul>
...
<?php echo $__env->make('layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\PureEarth-Test-app\resources\views/education.blade.php ENDPATH**/ ?>