            ...
            <div class="swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="<?php echo e(asset('img/pollution-1.jpg')); ?>" alt="Image" class="img-fluid w-100">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo e(asset('img/pollution-5.jpg')); ?>" alt="Image" class="img-fluid w-100">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo e(asset('img/pollution-2.jpg')); ?>" alt="Image" class="img-fluid w-100">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo e(asset('img/pollution-3.jpg')); ?>" alt="Image" class="img-fluid w-100">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo e(asset('img/pollution-4.jpg')); ?>" alt="Image" class="img-fluid w-100">
                </div>
              </div>
          ...
          <div class="row justify-content-center">
            <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 order-lg-2 offset-xl-1 mb-4">
              <div class="img-wrap text-center text-md-left" data-aos="fade-up" data-aos-delay="100">
                <div class="img">
                  <img src="<?php echo e(asset('img/our-mission.jpg')); ?>" alt="circle image" class="img-fluid">
                </div>
              </div>
            </div>
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-5">
            <div class="images-overlap">
              <img src="<?php echo e(asset('img/why-us.jpg')); ?>" alt="student" class="img-fluid img-1" data-aos="fade-up">
            </div>
          </div>
          ...
          <div class="row gap-x-lg-4 justify-content-between">
            ...
            <div class="col-lg-8">
              <div class="swiper init-swiper-tabs">
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="<?php echo e(asset('img/problem-1.jpg')); ?>" alt="Image" class="img-fluid w-100">
                    <div class="p-4">
                  ...
                  <div class="swiper-slide">
                    <img src="<?php echo e(asset('img/problem-2.jpg')); ?>" alt="Image" class="img-fluid w-100">
                    <div class="p-4">
                  ...
                  <div class="swiper-slide">
                    <img src="<?php echo e(asset('img/problem-3.jpg')); ?>" alt="Image" class="img-fluid w-100">
                    <div class="p-4">
                  ...
                  <div class="swiper-slide">
                    <img src="<?php echo e(asset('img/problem-4.jpg')); ?>" alt="Image" class="img-fluid w-100">
                    <div class="p-4">
        ...
        <div class="row gy-4">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
                <a href="/education/1" class="thumb d-block"><img src="<?php echo e(asset('img/education/education-1.jpg')); ?>" alt="Image" class="img-fluid rounded"></a>
                ...
                <div class="d-flex author align-items-center">
                    <div class="pic">
                    <img src="<?php echo e(asset('img/education/author-1.jpg')); ?>" alt="Image" class="img-fluid rounded-circle">
                    </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
              <a href="/education/2" class="thumb d-block"><img src="<?php echo e(asset('img/education/education-2.jpg')); ?>" alt="Image" class="img-fluid rounded"></a>
              ...
              <div class="post-content">
                ...
                <div class="d-flex author align-items-center">
                  <div class="pic">
                    <img src="<?php echo e(asset('img/education/author-2.jpg')); ?>" alt="Image" class="img-fluid rounded-circle">
                  </div>
                  <div class="author-name">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="300">
              <a href="/education/3" class="thumb d-block"><img src="<?php echo e(asset('img/education/education-3.jpg')); ?>" alt="Image" class="img-fluid rounded"></a>
              ...
              <div class="post-content">
                ...
                <div class="d-flex author align-items-center">
                  <div class="pic">
                    <img src="<?php echo e(asset('img/education/author-3.jpg')); ?>" alt="Image" class="img-fluid rounded-circle">
                  </div>
                  <div class="author-name">
...
<?php echo $__env->make('layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\PureEarth-Test-app\resources\views/index.blade.php ENDPATH**/ ?>